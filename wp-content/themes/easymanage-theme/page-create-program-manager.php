...
if (isset($_POST['create-pm-submit'])) {
    ...
    $res = wp_remote_post('http://localhost/EasyManage/wp-json/api/v1/users/program_manager', [
        'methods' => 'POST',
...
<form action="" method="post">
    ...
    <div class="page-create-employee">
        <div class="inner-form" >
            <h2 style="font-size: 23px;">Create Program Manager</h2>
            ...
            <button class="custom-btn" type="submit" name="create-pm-submit">Create</button>
        </div>
    </div>
</form>
